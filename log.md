...
4. Currently training the modified model with 45 epochs, learning rate(adaptive) = 0.05(initial), batch size is 60, total number of images in the training set is 60k, and the max label length allowed is 15. 
